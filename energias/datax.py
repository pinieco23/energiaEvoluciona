...
def create_comments_url(graph_url,post_id, APP_ID, APP_SECRET):
    comments_args = post_id + "/comments/?key=value&access_token=" + 413994742481730 + "|" + "a019694f9ee8ca74969f8a25370f7c87"
    comments_url = graph_url + comments_args
    return comments_url

# defined function that creates post_url
def create_post_url(graph_url, APP_ID, APP_SECRET):
    post_args = "/posts/?key=value&access_token=" + 413994742481730 + "|" + "a019694f9ee8ca74969f8a25370f7c87"
